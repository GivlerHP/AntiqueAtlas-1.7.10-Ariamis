...
public class ItemAtlas extends Item implements IBauble {
	...
	public baubles.api.BaubleType getBaubleType(ItemStack stack) {
		return baubles.api.BaubleType.BELT; // Теперь атлас можно вставить в слот пояса
	}
	...
	@Override
	public boolean canEquip(ItemStack stack, net.minecraft.entity.EntityLivingBase player) { return true; }

	@Override
	public boolean canUnequip(ItemStack stack, net.minecraft.entity.EntityLivingBase player) { return true; }
